...
public class Main {
    public static void main(String[] args) throws InvalidMidiDataException {
        PianoRoll pianoRoll = new PianoRoll(126,-1);
        Note[] lead = {
                //F# F# C# B A
        ...
        int leadTicks[]={
                leadTick+=4,
                leadTick+=4,leadTick+=2,leadTick+=2,leadTick+=4,leadTick+=4,
                leadTick+=4,leadTick+=2,leadTick+=2,leadTick+=4,leadTick+=2,leadTick+=2,
                leadTick+=4,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,
                leadTick+=4,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,
                ...
                leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,
                leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,
                leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,
                leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2,leadTick+=2
        };
        ...
        int[] chordTicks={
                chordTick+=4,
                chordTick,chordTick,chordTick+=16,
                chordTick,chordTick,chordTick+=16,
                chordTick,chordTick,chordTick+=16,
                chordTick,chordTick,chordTick+=16,
